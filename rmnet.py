...
class RMNETWGAN():
    def __init__(self,config):
        ...
        #Configure Loader
        self.img_dir = r'./images/train/attic/'
        self.masks_dir = r'./masks/train/'
    ...
    # =================================================================================== #         
        try:
            self.multi_model = multi_gpu_model(self.combined, gpus=1)
        ...
        for epoch in range(1, self.num_epochs + 1):
            for databatchs in range(dataLoads):
                ...
                for batch in range(batches):
                    ...
                    # =================================================================================== #
                    if batch%100 == 0: 
                    	print("Epoch: %d Batch: %d/%d dataloads: %d/%d [D loss: %f, op_acc: %.2f%%]  [G loss: %f MSE loss: %f]" % (epoch + self.current_epoch, batch, batches,databatchs,dataLoads, d_loss[0], 100*d_loss[1], g_loss[0], g_loss[1]))
